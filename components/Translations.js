...
function createTranslations(brandSubtitle) {
  ...
  return {
    en: {
      ...
      candidateAlreadyExists: "Already Added",
      spinning: "Searching...",
    ...
    zh: {
      ...
      slotMachineTitle: "甲崩喔",
      spinButton: "下一個",
      addCandidate: "保留",
      candidateAdded: "已加入",
      candidateAlreadyExists: "加過了",
      spinning: "正在搜尋...",
    ...
    vi: {
      ...
      candidateAlreadyExists: "Đã có rồi",
    ...
    ms: {
      ...
      candidateAlreadyExists: "Sudah ada",
